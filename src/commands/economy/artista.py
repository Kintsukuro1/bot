...
def _iniciar_artista_db(user_id, tipo_trabajo):
    ...
    return nivel_info, energia_actual, energia_requerida, has_mejora_8
...
async def iniciar_trabajo_artista(interaction: discord.Interaction):
    ...
    nivel_info, energia_actual, energia_requerida, has_mejora_8 = await asyncio.to_thread(_iniciar_artista_db, user_id, tipo_trabajo)
